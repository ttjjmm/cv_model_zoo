...
if __name__ == '__main__':
    # m = convnext_tiny(pretrained=True, drop_path_rate=0.4, layer_scale_init_value=1.0)
    # inp = torch.randn((4, 3, 320, 320))
    # print(m(inp).shape)
    dp_rates = [x.item() for x in torch.linspace(0, 0.4, sum([3, 3, 9, 3]))]
    print(dp_rates)
...
class ConvNextBottleneck(nn.Module):
    def __init__(self, in_chans, out_chans, depths, dp_rates, layer_scale_init_value=1.0):
